...
# Get installed software and check installation status.
Function Get-InstalledSoftwareStatus
{
    [cmdletbinding()]	
...
# Get installed software and check installation status.
Get-InstalledSoftwareStatus -Name $Name -Version $Version -Method $Method;
