...
# Get installed software and check detection status.
Function Get-InstalledSoftwareDetection
{
    [cmdletbinding()]	
    ...
    $Response = Test-InstalledSoftware -Name $Name -Version $Version -InstalledSoftware $InstalledSoftware;
...
# Get installed software and check detection status.
Get-InstalledSoftwareDetection -Name $Name -Version $Version -Method $Method;
